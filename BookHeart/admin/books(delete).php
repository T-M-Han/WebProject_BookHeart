...
<head>
    ...
    <!-- Include the JavaScript file for handling update operations -->
...
<body>
    ...
    <nav>
        <ul>
            ...
            <li><a href="books(delete).php"class="active">BOOKS(Deletion)</a></li>
    ...
    <div class="section">
        <h2>Deletion Book Details</h2>
        <form action="delete.php" method="post" enctype="multipart/form-data" id="updateForm">
            <label for="bookid">Book ID:</label>
            <!-- Input field to select the book ID to delete -->
            <input type="text" name="bookid" id="selectedBookId">

            <!-- Button to submit the form for book deletion -->
